...
const Code = ({codeString='console.log("hello, world")', filename='*Untitled.txt', language='javascript'}) => {
  const [copy, setCopy] = useState(false)
  return (
      <div className='mt-10 max-w-3xl min-w-[25rem] bg-[#3a404d] rounded-md overflow-hidden'>
